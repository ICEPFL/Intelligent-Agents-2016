...
public class Searcher {
	...
	private int maxIteration = 1800;
	
	public static Result searchSolution(List<EnVehicle> vehicles, List<Task> tasks){
		Searcher searcher = new Searcher(vehicles, tasks);
		return searcher.searchSolution();
	}
	
	public Searcher(List<EnVehicle> vehicles, List<Task> tasks){
	...
	public Result searchSolution(){
		...
		return new Result(this.bestCost, this.bestStepMap);
